...
('寰烽緳 (De''Longhi) 鎰忓紡鍗婅嚜鍔ㄥ挅鍟℃満 - 95鎴愭柊', '鎴愯壊寰堝ソ锛屼娇鐢ㄦ椂闂翠笉闀匡紝鍔熻兘姝ｅ父锛岄厤浠堕綈鍏ㄣ€?, 3200.00, '95鎴愭柊', '/api/file/44dc84a59ccd486b9b0a383c556c9d9b.jpg', '["/api/file/44dc84a59ccd486b9b0a383c556c9d9b.jpg"]', 'u002', 'market', 5480.00, '娴︿笢鏂板尯', 1, 1, 'active'),
('Nintendo Switch 鏃ョ増绾㈣摑 - 甯﹀仴韬幆', '闂茬疆鍗婂勾锛屾暣鏈轰繚瀛樿壇濂斤紝鍖呰鍜岄厤浠堕綈鍏ㄣ€?, 1800.00, '99鏂?, '/api/file/d0f83c5066454d7c958a3fb0e954c5a2.jpg', '["/api/file/d0f83c5066454d7c958a3fb0e954c5a2.jpg"]', 'u003', 'market', 2400.00, '寰愭眹鍖?, 1, 1, 'active');
