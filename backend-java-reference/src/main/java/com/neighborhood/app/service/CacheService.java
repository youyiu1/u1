...
public class CacheService {
    ...
    private static final long USER_TTL = 30; // 30分钟
    ...
    private static final long NEWS_LIST_TTL = 10; // 10分钟
    private static final long NEWS_DETAIL_TTL = 15; // 15分钟
    ...
    public <T> T getCachedNewsList(Class<T> clazz) {
        try {
    ...
    public <T> T getCachedNewsList() {
        return (T) getCachedNewsList(ArrayList.class);
    }
    ...
    private static final long SERVICE_LIST_TTL = 10; // 10分钟
    private static final long SERVICE_DETAIL_TTL = 15; // 15分钟
    ...
    private static final long MARKET_LIST_TTL = 10; // 10分钟
    private static final long MARKET_DETAIL_TTL = 15; // 15分钟
    ...
    private static final long HOME_INDEX_TTL = 5; // 5分钟
