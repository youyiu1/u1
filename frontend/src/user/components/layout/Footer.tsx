...
export default function Footer() {
  return (
    <footer className="border-t border-stone-300 bg-[#f7f7f5] text-ink">
      <div className="mx-auto max-w-[1280px] px-4 py-10 sm:px-6 sm:py-12 lg:px-20">
        ...
        <div className="mt-8 flex flex-col gap-2 border-t border-stone-300 pt-5 text-xs text-muted sm:flex-row sm:items-center sm:justify-between">
          <p>© 2026 同城生活</p>
