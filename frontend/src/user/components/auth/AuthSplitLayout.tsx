...
export function AuthSplitLayout({
  ...
  return (
    <div className="min-h-[calc(100vh-80px)]">
      <div className="grid min-h-[calc(100vh-80px)] w-full overflow-hidden bg-white lg:grid-cols-[minmax(0,1fr)_480px]">
        <motion.section
        ...
        <motion.section
          ...
          className="flex min-h-full flex-col bg-white px-5 py-6 sm:px-7 sm:py-7 lg:px-9 lg:py-8"
        >
