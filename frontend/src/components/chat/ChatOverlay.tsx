                    ...
                    return (
                      ...
                      >
                        <div className={`max-w-[80%] space-y-1 ${isMe ? 'items-end' : 'items-start'} flex flex-col`}>
                          <div className={`px-4 py-3 rounded-[24px] text-sm font-medium shadow-sm leading-relaxed ${
                            isMe
                              ? 'bg-primary text-white rounded-tr-none'
                              : 'bg-stone-100 text-ink rounded-tl-none'
                          }`}>
                            {type === 'image' && msg.mediaUrl ? (
                              <img src={msg.mediaUrl} alt="chat" className="max-w-full rounded-2xl" />
                            ) : (
                  ...
                  {pendingImagePreview && (
                    <div className="mb-3 flex items-center justify-between gap-3 rounded-3xl border border-hairline bg-surface-soft p-3">
                      <div className="flex items-center gap-3 min-w-0">
                        <img src={pendingImagePreview} alt="preview" className="w-14 h-14 rounded-2xl object-cover shrink-0" />
