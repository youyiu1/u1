            ...
            <div className="group relative z-10 flex flex-col items-center gap-8 rounded-[40px] border border-hairline bg-white p-8 shadow-sm md:flex-row">
              ...
              <div className="flex-1 text-center md:text-left">
                ...
                <div className="flex items-center justify-center gap-8 md:justify-start">
                  <div>
                    <p className="mb-1 text-xs font-black uppercase tracking-widest text-muted">服务完成</p>
                    <p className="text-lg font-black text-ink">{service.seller?.soldCount || 0}+</p>
                  </div>
                  <div>
                    <p className="mb-1 text-xs font-black uppercase tracking-widest text-muted">粉丝数</p>
                    <p className="text-lg font-black text-ink">{service.seller?.followersCount || 0}</p>
                  </div>
                  <div>
                    <p className="mb-1 text-xs font-black uppercase tracking-widest text-muted">平均响应</p>
            ...
            <div className="space-y-16 px-2">
              ...
              <div className="grid grid-cols-1 gap-4 md:grid-cols-2">
                {[
                  ...
                  <div key={item.title} className="flex gap-4 rounded-3xl border border-hairline bg-white p-6 shadow-sm transition-all hover:border-primary/20">
                    <div className="shrink-0">{item.icon}</div>
                    <div>
                      <h4 className="mb-1 font-black text-ink">{item.title}</h4>
          ...
          <aside className="sticky top-28 lg:col-span-4">
            <div className="space-y-8 rounded-[48px] border border-hairline bg-white p-8 shadow-2xl shadow-ink/5 md:p-10">
              ...
              <div className="mt-6 space-y-4 border-t border-hairline pt-6">
                ...
                <div className="flex items-center justify-between text-sm font-medium">
                  <span className="text-muted">结束时间</span>
                  <span className="font-black text-ink">{endTime}</span>
                </div>
                <div className="flex items-center justify-between text-sm font-medium">
                  <span className="text-muted">服务费用</span>
                  <span className="font-black text-ink">￥{service.price * (duration / 4)}</span>
                </div>
                <div className="flex items-center justify-between text-sm font-medium">
                  <span className="text-muted">平台保障</span>
                  <span className="font-black text-green-600">已包含</span>
                </div>
                <div className="flex items-center justify-between text-sm font-medium">
                  <span className="text-muted">预计服务费</span>
