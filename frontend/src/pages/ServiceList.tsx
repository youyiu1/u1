...
export default function ServiceList() {
  ...
  return (
    <div className="bg-white min-h-screen pb-20">
      <div className="bg-primary/5 pt-10 sm:pt-12 pb-8">
        <div className="max-w-[1280px] mx-auto px-4 sm:px-6 lg:px-20">
           <div className="flex flex-col md:flex-row gap-4 sm:gap-6 items-stretch md:items-end justify-between">
             <div className="flex-1 max-w-2xl">
               <h1 className="text-2xl sm:text-3xl font-bold text-ink mb-4 sm:mb-6">发现身边的专业服务</h1>
             ...
             <button onClick={() => requireAuth(() => openPublish())} className="w-full md:w-auto justify-center px-6 sm:px-8 py-3.5 sm:py-4 bg-primary text-white rounded-2xl font-bold shadow-lg shadow-primary/10 hover:bg-primary-hover transition-all flex items-center gap-2">
      ...
      <main className="max-w-[1280px] mx-auto px-4 sm:px-6 lg:px-20 py-10 sm:py-12">
        <div className="flex flex-col md:flex-row md:items-center justify-between gap-4 mb-6 sm:mb-8">
          <div>
            <h2 className="text-lg sm:text-xl font-bold text-ink">精选服务商</h2>
          ...
          <div className="flex flex-col md:items-end gap-2 w-full md:w-auto">
            <button
              ...
              disabled={locating}
              className={`w-full md:w-auto justify-center px-5 py-2.5 rounded-xl text-xs font-black transition-all flex items-center gap-2 ${
                nearbyEnabled
