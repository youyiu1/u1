...
import { Search, Filter, SlidersHorizontal, ChevronDown, Star, MapPin, CheckCircle2, Heart, Sparkles, Clock, ShieldCheck, Zap, Scissors, Dumbbell, Wrench, Brush } from 'lucide-react';
...
const CATEGORIES = [
  ...
  { id: 'pets', name: '宠物生活', icon: <Scissors className="w-4 h-4" /> },
